...
%eval(['!copy z:\pos350\CTD\pre_processed\dp350_',int2str0(stn,3),...
%  	's1s2s3s4s5s6_1dbar.cnv data\raw_ctdprof'])
...
[hdr,data] = hdrload(['data/raw_ctdprof/dp350_',int2str0(stn,3),'s1s2s3s4s5s6_1dbar.cnv']);
ctdprof = data(:,[5,6,11]);
