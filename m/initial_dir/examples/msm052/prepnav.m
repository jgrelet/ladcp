...
[hdr,data] = hdrload(['data/raw_nav/msm052_',int2str0(stn,3),'_1sec.cnv']);
...
if mversion>=70
  save(['data/nav/nav',int2str0(stn,3)],'timnav','data','-v6')
else
  save(['data/nav/nav',int2str0(stn,3)],'timnav','data')
end
